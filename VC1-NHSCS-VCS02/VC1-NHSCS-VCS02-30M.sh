#!/bin/bash
#Alert Script for vc1-nhscs-vcs02 - 30 Minute Intervals
if ping -c 1 10.162.150.57 > /dev/null
  then
    ...
    dc01stat4=$(cat /cachet-scripts/status/vc1-nhscs-vcs02-S4.txt)
    if [ $dc01stat1 = "1" ];
      then
